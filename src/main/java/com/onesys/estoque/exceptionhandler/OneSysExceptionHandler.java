package com.onesys.estoque.exceptionhandler;
 ...
 */
@ControllerAdvice
public class OneSysExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private List<Erro> criarListaDeErro(BindingResult bindingResult) {
        ...
        for (FieldError erroCampo : bindingResult.getFieldErrors()) {
